...
PinChangeIntHandler (void)
{
	...
	unsigned long ulPortVal_A;
	unsigned long ulPortVal_B;
	long lDiff;
	...
	//
	// Read the pin
	ulPortVal_A = GPIOPinRead (GPIO_PORTF_BASE, GPIO_PIN_5);
	ulPortVal_B = GPIOPinRead (GPIO_PORTF_BASE, GPIO_PIN_7);
	//
